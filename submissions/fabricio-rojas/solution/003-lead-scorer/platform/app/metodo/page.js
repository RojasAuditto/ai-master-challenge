      ...
      <div className="grid g2" style={{ alignItems: 'start' }}>
        <Rise>
          <div className="card" id="api" style={{ padding: 24 }}>
            <div className="card-h"><div><h3>API do score</h3><span className="sub">O mesmo score e a mesma explicação, para o CRM ou um bot</span></div><span className="pill lime">GET</span></div>
